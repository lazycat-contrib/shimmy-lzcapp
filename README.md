...
The application provides two launcher entries on the same domain. The default `main` entry opens the help page:

- `Shimmy` opens `/help` with the current instance API base URL and endpoint list.
